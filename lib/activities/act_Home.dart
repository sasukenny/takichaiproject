...
class _HomeState extends State<Home> {
  ...
  Container elements(BuildContext context){
    ...
    comp_card thirdComponent = comp_card(titulo: 'Mis creaciones', flexText: 9, newRoute: MySongs(),divide: 2.19,  content: 'Comparte tus obras con el mundo',imgbg: "assets/images/create.jpeg",);
